...
local function attackone()
    ...
    attack = true
        ...
        Neck.C0 = clerp(Neck.C0, necko * angles(math.rad(0), math.rad(0), math.rad(40+11*i)), 0.2)
...
attackdebounce = false
        ...
        Neck.C0 = clerp(Neck.C0, necko * angles(math.rad(-4), math.rad(0), math.rad(-23)), 0.35)
...
local function attacktwo()
    ...
    attack = true
        ...
        Neck.C0 = clerp(Neck.C0, necko * angles(math.rad(0), math.rad(0), math.rad(-40)), 0.2)
...
attackdebounce = false
        ...
        Neck.C0 = clerp(Neck.C0, necko * angles(math.rad(-4), math.rad(0), math.rad(27)), 0.35)
...
attackdebounce = false
        ...
        Neck.C0 = clerp(Neck.C0, necko * angles(math.rad(12), math.rad(0), math.rad(24)), 0.35)
...
local function attackfour()
    ...
    attack = true
     ...
     WaveEffect(BrickColor.new("White"), root.CFrame * CFrame.new(0, -1, 0) * euler(0, math.random(-50, 50), 0), 1, 1, 1, 1, 0.5, 1, 0.05)
        ...
        Neck.C0 = clerp(Neck.C0, necko * angles(math.rad(0+11*i), math.rad(0), math.rad(0)), 0.2)
...
attackdebounce = false
        ...
        Neck.C0 = clerp(Neck.C0, necko * angles(math.rad(-43), math.rad(0), math.rad(0)), 0.42)
...
local function Taunt()
	...
	for i = 0, 8.2, 0.1 do
		...
		Neck.C0 = clerp(Neck.C0, necko* CF(0, 0, 0 + ((1* Player_Size) - 1)) * angles(Rad(25), Rad(0), Rad(16 * Cos(sine / 12))), 0.2)
    ...
    attack = true
     ...
     WaveEffect(BrickColor.new("White"), root.CFrame * CFrame.new(0, -1, 0) * euler(0, math.random(-50, 50), 0), 1, 1, 1, 1, 0.5, 1, 0.05)
      for i = 0, 7.14, 0.1 do
        ...
        Neck.C0 = clerp(Neck.C0, necko * angles(math.rad(0), math.rad(0), math.rad(0)), 0.2)
...
local Cracking = Cso("292536356", tors, 10, 1)
 for i = 0, 7.14, 0.1 do
        ...
        rootj.C0 = clerp(rootj.C0, RootCF * CFrame.new(0, 0, -0.8) * angles(math.rad(24), math.rad(0), math.rad(0)), 0.2)
        Neck.C0 = clerp(Neck.C0, necko * angles(math.rad(30), math.rad(0), math.rad(0)), 0.2)
        RW.C0 = clerp(RW.C0, CFrame.new(1.5, 0.5, 0) * angles(math.rad(20), math.rad(0), math.rad(36)), 0.3)
        LW.C0 = clerp(LW.C0, CFrame.new(-1.5, 0.5, 0) * angles(math.rad(20), math.rad(0), math.rad(-36)), 0.3)
        RH.C0 = clerp(RH.C0, CFrame.new(1, -0.6, -0.3) * RHCF * angles(math.rad(0), math.rad(0), math.rad(-28)), 0.2)
        LH.C0 = clerp(LH.C0, CFrame.new(-1, -0.2, -0.5) * LHCF * angles(math.rad(0), math.rad(0), math.rad(-34)), 0.2)
...
local function Galekicks()
    ...
    attack = true
        ...
        Neck.C0 = clerp(Neck.C0, necko * angles(math.rad(0), math.rad(-17), math.rad(-90)), 0.2)
...
attackdebounce = false
        ...
        Neck.C0 = clerp(Neck.C0, necko * angles(math.rad(0), math.rad(-24), math.rad(-90)), 0.7)
...
table.insert(Events, mouse.KeyUp:connect(function(key)
    if string.byte(key) == 48 then
        Swing = 1
        hum.WalkSpeed = 8
	end
...
--Start Animations--
-------------------------------------------------------
Music.SoundId = getsynasset("GelatekHub/Scripts/GaleFighter.mp3")
Music.Looped = true
Music.Pitch = 1
Music.Volume = 0.7
Music.Parent = tors
	...
	if equipped == true or equipped == false then
		...
		elseif torvel < 1 and hitfloor ~= nil then
			...
			if attack == false then
				...
				Neck.C0 = clerp(Neck.C0, necko* CF(0, 0, 0 + ((1* Player_Size) - 1)) * angles(Rad(-6.5 * Sin(sine / 12)), Rad(0), Rad(-20)), 0.1)
		...
		elseif torvel > 2 and torvel < 22 and hitfloor ~= nil then
			...
			if attack == false then
				...
				Neck.C0 = clerp(Neck.C0, necko* CF(0, 0, 0 + ((1* Player_Size) - 1)) * angles(Rad(-1), Rad(0), Rad(0) - hed.RotVelocity.Y / 15), 0.15)
		...
		elseif torvel >= 22 and hitfloor ~= nil then
			...
			Neck.C0 = clerp(Neck.C0, necko* CF(0, 0, 0 + ((1* Player_Size) - 1)) * angles(Rad(-8.5 - 2 * Sin(sine / 20)), Rad(0), Rad(0) - hed.RotVelocity.Y / 15), 0.15)
