...
local Hat1 = char:FindFirstChild("JUMBO Voodoo Doll")
local Hat2 = char:FindFirstChild("Red SS")
if Hat1 then
	Global.AlignPart(Hat1.Handle, Handle)
	for i,v in pairs(Doll:GetDescendants()) do
		if v:IsA("BasePart") then
			v.Transparency = 1
		end
		if v:IsA("Mesh") or v:IsA("CylinderMesh") or v:IsA("SpecialMesh") or v:IsA("Decal") then
			v:Destroy()
		end
	end
end
if Hat2 then
	...
	Hat2.Handle:BreakJoints()
	table.insert(Events, game:GetService("RunService").PostSimulation:Connect(function()
		if attack == false then
			Hat2.Handle.CFrame = Handle2.CFrame * CFrame.new(0, 0.8, 0) * CFrame.Angles(math.rad(90),math.rad(45),math.rad(60))
		else
			Hat2.Handle.CFrame = Handle2.CFrame * CFrame.new(0, 0.5, -0.2) * CFrame.Angles(math.rad(90),math.rad(45),math.rad(90))
		end
		Hat2.Handle.Velocity = Vector3.new()
	end))
end
...
if Bullet then
	...
	funnyfunction = function(target)
		...
		local part = target:FindFirstChild("Head") or target:FindFirstChild("HumanoidRootPart") or target:FindFirstChildOfClass("BasePart")
		funnyattacking = "no"
		task.spawn(function()
			for i = 1,20 do
				Pos.Position = part.Position + Vector3.new(rd(-3,3),rd(-1,1),rd(-3,3))
				wait(0.03)
			end
			funnyattacking = "yes"
		end)
...
function dmg(dude)
if dude.Name ~= char then
if Bullet then funnyfunction(dude) end
end
end
	...
	for _, c in pairs(workspace:children()) do
		...
		if hum ~= nil then
			...
			if head ~= nil then
				...
				if c.Name ~= char then
				if c.Name ~= "naenaeaweasdasasdsdfafa" then
...
function HAAH()
	...
	for i = 0,9,0.1 do
		...
		neck.C0 = clerp(neck.C0, necko * angles(Rad(-30 - 2.5 * Sin(sine / 2)), Rad(0), Rad(0)), 0.3)
		if Mrandom(1,15) == 1 then
		neck.C0 = clerp(neck.C0, necko * CF(0, 0, 0 + ((1) - 1)) * angles(Rad(Mrandom(-15,15)), Rad(Mrandom(-15,15)), Rad(Mrandom(-15,15))), 1)
		end
...
function doot_n_die()
    ...
    for i = 0, 2.4, 0.1 do
        ...
        neck.C0 = clerp(neck.C0, necko * angles(Rad(15), Rad(0), Rad(-25)), 0.3)
        if Mrandom(1,15) == 1 then
            neck.C0 = clerp(neck.C0, necko * angles(Rad(Mrandom(-20,20)), Rad(Mrandom(-20,20)), Rad(Mrandom(-20,20))), 0.3)
        end
    ...
    for i = 0, 1.4, 0.1 do
        ...
        neck.C0 = clerp(neck.C0, necko * angles(Rad(-15), Rad(0), Rad(-25)), 0.3)
        if Mrandom(1,15) == 1 then
            neck.C0 = clerp(neck.C0, necko * angles(Rad(Mrandom(-50,50)), Rad(Mrandom(-50,50)), Rad(Mrandom(-50,50))), 0.3)
        end
        RH.C0 = clerp(RH.C0, CF(1, -0.9 - 0.1 * Cos(sine / 20), 0.025 * Cos(sine / 20)) * RHCF * angles(Rad(-2.5), Rad(0), Rad(-10)), 0.15)
        LH.C0 = clerp(LH.C0, CF(-1, -0.9 - 0.1 * Cos(sine / 20), -.2 + 0.025 * Cos(sine / 20)) * LHCF * angles(Rad(-2.5), Rad(0), Rad(-10)), 0.15)
...
CreateSound("429400881", torsy, 10, .8)
    ...
    for i = 0, 2.4, 0.1 do
        swait()
        rootj.C0 = clerp(rootj.C0, RootCF * CF(0, 0, -0.1 + 0.1 * Cos(sine / 20)) * angles(Rad(10), Rad(0), Rad(0)), 0.15)
        neck.C0 = clerp(neck.C0, necko * angles(Rad(15), Rad(0), Rad(-25 * Cos(sine / 20))), 0.3)
        if Mrandom(1,15) == 1 then
            neck.C0 = clerp(neck.C0, necko * angles(Rad(Mrandom(-20,20)), Rad(Mrandom(-20,20)), Rad(Mrandom(-20,20))), 0.3)
        end
        RH.C0 = clerp(RH.C0, CF(1, -0.9 - 0.1 * Cos(sine / 20), 0.025 * Cos(sine / 20)) * RHCF * angles(Rad(-2.5), Rad(0), Rad(-10)), 0.15)
...
function doot_die_pls()
    ...
    for i = 0, 2, 0.1 do
        ...
        neck.C0 = clerp(neck.C0, necko * angles(Rad(0), Rad(0), Rad(0)), 0.3)
        if Mrandom(1,15) == 1 then
            neck.C0 = clerp(neck.C0, necko * angles(Rad(Mrandom(-20,20)), Rad(Mrandom(-20,20)), Rad(Mrandom(-20,20))), 0.3)
        end
        RH.C0 = clerp(RH.C0, CF(1, -0.9 - 0.1 * Cos(sine / 20), 0.025 * Cos(sine / 20)) * RHCF * angles(Rad(-2.5), Rad(0), Rad(-10)), 0.15)
    ...
    for i = 0, 2.2, 0.1 do
        ...
        neck.C0 = clerp(neck.C0, necko * angles(Rad(0), Rad(0), Rad(35)), 0.3)
        if Mrandom(1,15) == 1 then
            neck.C0 = clerp(neck.C0, necko * angles(Rad(Mrandom(-20,20)), Rad(Mrandom(-20,20)), Rad(Mrandom(-20,20))), 0.3)
        end
...
Music.SoundId = getsynasset("GelatekHub/Scripts/VoodooDoll.mp3")
Music.Looped = true
Music.Pitch = 1
Music.Volume = 2
Music.Parent = char
...
--AAAAAAAAAAAAAAAA
local sexos
sexos = game:GetService("RunService").Stepped:Connect(function()
	...
	if equipped == true or equipped == false then
		...
		elseif torvel < 1 and hitfloor ~= nil then
			...
			if attack == false then
				...
				neck.C0 = clerp(neck.C0, necko* CF(0, 0, 0 + ((1* Player_Size) - 1)) * angles(Rad(25 - 2.5 * Sin(sine / 30)), Rad(0), Rad(-20 + 2 * Cos(sine / .25))), 0.3)
				...
				if HeadTwitch == false and Mrandom(1, 25) == 1 then
					neck.C0 = clerp(neck.C0, necko* CF(0, 0, 0 + ((1* Player_Size) - 1)) * angles(Rad(Mrandom(-90, 90)), Rad(Mrandom(-90, 90)), Rad(Mrandom(-90, 90))), 0.15)
				end
			end
		elseif torvel < 50 and hitfloor ~= nil then
			...
			if attack == false then
				...
				neck.C0 = clerp(neck.C0, necko* CF(0, 0, 0 + ((1* Player_Size) - 1)) * angles(Rad(25 - 2.5 * Sin(sine / 7)), Rad(0), Rad(0) - hed.RotVelocity.Y / 15), 0.3)
