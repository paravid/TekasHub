...
local Hat = Char:FindFirstChild("Sniper")
if Hat then
	Hat.Handle:BreakJoints()
	table.insert(Events, game:GetService("RunService").PostSimulation:Connect(function()
		if Aiming == false then
			Hat.Handle.CFrame = Handle.CFrame * CFrame.new(-2.5, 0.5, 0.6) * CFrame.Angles(math.rad(0),math.rad(-160),math.rad(0))
		else
			Hat.Handle.CFrame = Handle.CFrame * CFrame.new(-2.75, 0.5, -0.4) * CFrame.Angles(math.rad(0),math.rad(-180),math.rad(0))
		end
